...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $kultur = Result::where('user_id', $user_id)->where('kat_id', 3)->get();
        ...
        return view('test.dashboard', compact('disable_privat','disable_beruf','enable_potential', 'disable_kultur', 'enable_kultur'));
