...
<div class="container">
    <div class="row justify-content-center">
        ...
        <p style="font-size:120%">Wir bieten Ihnen verschiedene Instrumente an, um als Individuum im Team (z.B. auch als
            Chef im Team) oder als gesamtes Team noch erfolgreicher zu.</p>
        <p style="font-size:120%">Unsere Fragebogen und die Auswertungen dazu geben Ihnen einen sofortigen, zumindest
            grob richtigen, Anhaltspunkt. Idealerweise wirken sie zusammen mit unseren Trainingsmaßnahmen, bei denen Sie
            &bdquo;echte&ldquo; Situationen durchleben und als ganze Pers&ouml;nlichkeit agieren. Beide Elemente, die
            wissenschaftlich fundierte Auswertung des Fragebogens und das Feedback aus den Erlebnisaktionen erlauben
            eine optimale Analyse und praxisgerechte Anleitung f&uuml;r die Umsetzung in Ihrem Unternehmensalltag.</p>
        <p style="font-size:120%">Wir beleuchten ein Team aus 3 Perspektiven (Ich im Team, Potentiale im Team und Kultur
            ...
            Potentiale und Kultur zu den Aufgaben oder liegen die Schwerpunkte &ndash; mit dem Modell gesprochen &ndash;
        ...
        <p style="font-size:120%">Weitere Informationen finden Sie im Abschnitt <a
                href="{{ route('information') }}">Information.</a></p>
    </div>
</div>
@endsection
