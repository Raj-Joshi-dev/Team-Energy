...
<head>
    ...
    @section('title', 'Über uns | Team-Energy')
</head>
...
<body>
    <div class="container">
        ...
        <!-- <img class="pb-3"
            src="{{ URL::asset('/images/Compass_Trainer_Network_LOGO_green.jpg') }}"
            alt="Company Pic" height="250"> -->
        ...
        <p style="font-size:120%;">COMPASS steht aber auch für ein handlungs- und erlebnisorientiertes Lernen in freier
            Natur (Outdoor) in Kombination mit klassischem Indoor-Lernen. Die dabei erarbeiteten theoretischen Inhalte
