...
<head>
    ...
    <title>{{ $user_name }} - Kultur im Team_#{{ $result_id }}_{{ $team_name }} | Team-Energy</title>
...
@section('content')
    ...
    <div class="center">
        ...
        <svg width="820" height="820" padding="150" xmlns="http://www.w3.org/2000/svg">
            ...
            <text class="description" style="font-weight: bold;" x="300" y="100">KULTUR IM TEAM - meine Einschätzung</text>
