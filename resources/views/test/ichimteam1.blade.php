                        ...
                        <div class="card">
                            ...
                            <div id="collapse{{$question->tid }}" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordionEx">
                                <div class="card-body">
                                    ...
                                    <ul class="answerList">
                                        <li>
                                            <label><input type="radio" name="answer[{{ $question->tid }}]" value="positive_x" {{ old('answer.'.$question->tid) == "positive_x" ? 'checked' : '' }} id="answerGroup_1">Ja</label>
                                        </li>
                                        <li>
                                            <label><input type="radio" name="answer[{{ $question->tid }}]" value="negative_x" {{ old('answer.'.$question->tid) == "negative_x" ? 'checked' : '' }} id="answerGroup_1">Eher Ja</label>
                                        </li>
                                    </ul>
                                    <div class="questions">
                                    ...
                                    <ul class="answerList">
                                        <li>
                                            <label><input type="radio" name="answer[{{ $question->tid }}]" value="positive_y" {{ old('answer.'.$question->tid) == "positive_y" ? 'checked' : '' }} id="answerGroup_1">Ja</label>
                                        </li>
                                        <li>
                                            <label><input type="radio" name="answer[{{ $question->tid }}]" value="negative_x" {{ old('answer.'.$question->tid) == "negative_y" ? 'checked' : '' }} id="answerGroup_1">Eher Ja</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
