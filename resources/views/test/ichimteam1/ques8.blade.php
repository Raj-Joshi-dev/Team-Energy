...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Wenn ich mich mit Freunden treffen will, machen wir meist einen Termin aus.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Mit Freunden treffe ich mich meist spontan?</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques9') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques7') }}" class="button" id="nextquestions">Früher</a><span>8 von 20</span></div>
    </div>
</div>
