...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: In Liebesfragen orientiere ich mich rein nach meinem Bauchgefühl.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Eine langfristig erfüllende Beziehung ist nur möglich, wenn gleichartige Grundhaltungen und gemeinsame Ziele gegeben sind.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques19') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques17') }}" class="button" id="nextquestions">Früher</a><span>18 von 20</span></div>
    </div>
</div>
