...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Bei uns zuhause gibt es ein paar feste Regeln (Essenszeiten, Familienzeiten,..), die uns helfen ein erfülltes Familienleben zu haben.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Bei uns zuhause geht es vor allem nach Zweckmäßigkeit. Wer Hunger hat, isst etwas, .. usw.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques6') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques4') }}" class="button" id="nextquestions">Früher</a><span>5 von 20</span></div>
    </div>
</div>
