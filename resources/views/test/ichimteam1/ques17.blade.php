...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Beim Skifahren sollte der Langsamste das Tempo bestimmen.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Es sollten Leistungsgruppen gebildet werden. Man kann sich ja in Abständen treffen.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques18') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques16') }}" class="button" id="nextquestions">Früher</a><span>17 von 20</span></div>
    </div>
</div>
