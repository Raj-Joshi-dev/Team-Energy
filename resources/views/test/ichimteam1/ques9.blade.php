...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Geld ist Mittel zum Zweck. In einer Notlage würde ich Freunden und Angehörigen helfen oder mir helfen lassen.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Ein finanzielles Polster ist wichtig für die Unabhängigkeit. Jeder ist verantwortlich für Notlagen vorzusorgen.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques10') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques8') }}" class="button" id="nextquestions">Früher</a><span>9 von 20</span></div>
    </div>
</div>
