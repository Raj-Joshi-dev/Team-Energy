...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Auf Schwächere muss man Rücksicht nehmen.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Auch Schwächere müssen sich bemühen und dürfgen es sich nicht bequem machen.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques13') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques11') }}" class="button" id="nextquestions">Früher</a><span>12 von 20</span></div>
    </div>
</div>
