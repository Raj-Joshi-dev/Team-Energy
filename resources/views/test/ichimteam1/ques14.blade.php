...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Man sollte Dinge ausdiskutieren, bis ein Kompromiss gefunden ist, mit dem Alle leben können.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Wenn nach einer angemessenen Zeit keine Einigung zu erzielen ist, sollte einfach abgestimmt werden.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques15') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques13') }}" class="button" id="nextquestions">Früher</a><span>14 von 20</span></div>
    </div>
</div>
