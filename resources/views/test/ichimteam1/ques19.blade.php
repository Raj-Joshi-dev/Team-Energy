...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Ich spende gerne und oft.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Wenn Personen unverschuldet in Not geraten helfe ich gezielt.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques20') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques18') }}" class="button" id="nextquestions">Früher</a><span>19 von 20</span></div>
    </div>
</div>
