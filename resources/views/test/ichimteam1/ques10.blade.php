...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Die Welt wird besser, wenn jeder mehr auf seine Mitmenschen eingeht.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Die Welt wird besser, wenn jeder bei sich selbst anfängt, Dinge besser zu machen.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques11') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques9') }}" class="button" id="nextquestions">Früher</a><span>10 von 20</span></div>
    </div>
</div>
