...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Jeder hat mal einen schlechten Tag. Dafür zeige ich auch Verständnis.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Auch als Privatperson bin ich Rollenwerwartungen ausgesetzt. Schwäche und Rückzug akzeptiere ich nicht.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques4') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques2') }}" class="button" id="nextquestions">Früher</a><span>3 von 20</span></div>
    </div>
</div>
