...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Ich vertraue meinem Partner/meinem besten Freund 100% und hinterfrage nicht.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Jeder Mensch ist Versuchungen ausgesetzt. Es ist weltfremd und unverantwortlich, blind zu vertrauen.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques17') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques15') }}" class="button" id="nextquestions">Früher</a><span>16 von 20</span></div>
    </div>
</div>
