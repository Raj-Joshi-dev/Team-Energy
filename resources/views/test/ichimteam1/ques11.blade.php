...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Manchmal halte ich notwendige Kritik zurück, weil ich Andere nicht verletzen will.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Für eine wirklich gute und stabile Beziehung halte ich es für notwendig, dass ich auch offen die Meinung sage.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques12') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques10') }}" class="button" id="nextquestions">Früher</a><span>11 von 20</span></div>
    </div>
</div>
