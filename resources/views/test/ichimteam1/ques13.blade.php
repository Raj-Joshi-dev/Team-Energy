...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            ...
            <div class="questions"><h3>These 1: Im Sport tobe ich mich so richtig aus.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: Im Sport habe ich ein Trainingsprogramm und ein klares Ziel.</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsRow"><a href="{{ route('ques14') }}" class="button" id="nextquestions">Nächste</a><a href="{{ route('ques12') }}" class="button" id="nextquestions">Früher</a><span>13 von 20</span></div>
    </div>
</div>
