...
<div class="container">
    <div class="privew">
        <div class="questionsBox">
            <div class="questions"><h1>Ich im Team - Beruflicher Bereich</h1></div>
            <div class="answerList"><h3>Bitte wählen Sie nur eine Option aus der unten angegebenen Arbeit aus.</h3></div>
            <div class="questions"><h3>These 1: abc</h3></div>
            <ul class="answerList">
                <li>
                    <label>
        ...
        <div class="questionsBox">
            <div class="questions"><h3>These 2: abc</h3></div>
            <ul class="answerList">
                <li>
                    <label>
