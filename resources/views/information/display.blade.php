                    ...
                    <div aria-multiselectable="true" class="accordion" id="accorID" role="tablist">
                            ...
                            <div class="card-header" id="headerOne" role="tabpanel">
                                <h5 class="mb-0">
                                    <button id="acclaimTooltip" style="font-weight: bold;font-size: 20px"
                                        title="Ich im Team" type="button" class="btn btn-light" data-toggle="collapse"
                                        data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"
                                        aria-multiselectable="true">Ich Im Team</button>
                                </h5>
                            </div>
                            <div class="collapse" id="collapseOne" aria-labelledby="headerOne" data-parent="#accorID">
                                <div class="card-body" style="font-size: 17px">Sie lernen die Chancen und Risiken Ihrer
                                    ...
                                    beruflichen Funktion Ihre Potentiale aussch&ouml;pfen oder falsch eingesetzt sind.
                                    Sie k&ouml;nnen bewusste Entscheidungen zu einer gew&uuml;nschten Entwicklung
                                    treffen und erhalten Hinweise auf die Entwicklungsrichtung - und ma&szlig;nahmen.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card multi">
                            ...
                            <div class="collapse" id="collapseTwo" aria-labelledby="headerTwo" data-parent="#accorID">
                                <div class="card-body" style="font-size: 17px">Sie sehen die Potentiale aller Individuen
                                    in Ihrem Team in einer Gesamtschau. Sie erkennen, ob Sie &uuml;berwiegend &bdquo;von
                        ...
                        <div class="card multi">
                            <div class="card-header" id="headerThree" role="tabpanel">
                                <h5 class="mb-0">
                                    <button type="button" id="acclaimTooltip" style="font-weight: bold;font-size: 20px"
                                        title="Kultur im Team" class="btn btn-light" data-toggle="collapse"
                                        data-target="#collapseThree" aria-expanded="true"
                                        aria-controls="collapseThree">Kultur im Team</button>
                                </h5>
                            </div>
                            <div class="collapse" id="collapseThree" aria-labelledby="headerThree"
                                ...
                                <div class="card-body" style="font-size: 17px">Die Kultur in einem Team ist mehr und
                                    ...
                                    Einzelpotentiale.<br />
                                    Der Chef pr&auml;gt die Kultur wesentlich, alle (dienst-)&auml;lteren Mitarbeiter
